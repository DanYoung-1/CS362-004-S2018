...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) {
    case adventurer:
          return adventurerAction(drawntreasurem currentPlayer, state, cardDrawn, z, temphand);
    case council_room:
          return council_roomAction(currentPlayer, state, handPos);
    case feast:
          return feastAction(state, currentPlayer, temphand, x, choice1);
    case gardens:
          return -1;
    case mine:
          return mineAction(state, j, currentPlayer, choice1, choice2, handPos);
    case remodel:
...
int adventurerAction(int drawntreasure, int currentPlayer, struct gameState *state, int cardDrawn, int z, int *temphand) {
...
int feastAction(struct gameState *state, int currentPlayer, int *temphand, int x, int choice1) {
...
int mineAction(struct gameState *state, int j, int currentPlayer, int choice1, int choice2, int handPos) {
    j = state->hand[currentPlayer][choice1];  //store card we will trash
